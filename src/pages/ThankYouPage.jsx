    ...
    <>
      <div className={styles.fullPage}>
        ...
        <main className={styles.main}>
          ...
          <br />
          <p className={styles.p}>
            Your Author Application has been submitted and you are now one step closer to being listed on our site.
          </p>
          <br />
          ...
          <p className={styles.p}>
            ...
            author site and create at least one social media promotion telling
            the world about Indie Book Vault. By doing that we create a
            community supported network where readers can find us simply by
            clicking the link on their favorite indie author's site.
          </p>
          <br />
          <p className={styles.p}>
