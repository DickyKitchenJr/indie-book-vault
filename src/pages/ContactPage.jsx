      ...
      <main className={styles.main}>
        ...
        <div className={styles.explanation}>
          ...
          <ul className={styles.ul}>
            ...
            <li>
              Authors must post at least one social media post informing readers
              and other writers that we exist
            </li>
            <li>
              Authors that <span className={styles.underline}>do not</span> have
              a website can be considered if they are willing to put monthly
              social media post up promoting Indie Book Vault
            </li>
          </ul>
        </div>
        <AuthorApplication />
        <p className={styles.explanation}>
          Feel free to reach out to us on social media at: TBD
        </p>
      </main>
      <Footer />
    </>
